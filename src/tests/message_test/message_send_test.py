...
def test_send_unauthorized(reset, test_channel, test_user, new_user):
...
def test_send_empty(reset, test_channel, test_user, new_user):
...
def test_send_invalidtoken(reset, test_channel, test_user, invalid_token):
