...
def test_profile_setname(reset, test_user): # pylint: disable=W0613
    '''
...
def test_profile_setname_empty_firstname(reset, test_user): # pylint: disable=W0613
    '''
...
def test_profile_setname_firstname_exceed_char_limit(reset, test_user): # pylint: disable=W0613
    '''
    Testing that the user_profile_setname function will raise an InputError
...
def test_profile_setname_empty_lastname(reset, test_user): # pylint: disable=W0613
    '''
    Testing that the user_profile_setname function will raise an InputError
...
def test_profile_setname_lastname_exceed_char_limit(reset, test_user): # pylint: disable=W0613
    '''
    Testing that the user_profile_setname function will raise an InputError
...
def test_profile_setname_invalidtoken(reset, invalid_token): # pylint: disable=W0613
    '''
