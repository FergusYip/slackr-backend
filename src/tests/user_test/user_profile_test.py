...
def test_averagecase_email(reset, test_user):
    ...
    assert  profile_information['user']['email'] == 'test@test.com'
...
def test_averagecase_firstname(reset, test_user):
    ...
    assert profile_information['user']['name_first'] == 'Lorem'
...
def test_averagecase_lastname(reset, test_user):
    ...
    assert profile_information['user']['name_last'] == 'Ipsum'
...
def test_averagecase_handle(reset, test_user):
    ...
    assert profile_information['user']['handle_str'] == 'testhandle'
