...
def test_details_owner(dummy_user1, channel1):  # pylint: disable=W0621
    '''
...
def test_details_added_owner(dummy_user1, dummy_user2, channel1):  # pylint: disable=W0621
    '''
...
def test_details_all(dummy_user1, channel1):  # pylint: disable=W0621
    '''
...
def test_details_invalid(dummy_user1, channel2):  # pylint: disable=W0621
    '''
...
def test_details_invalid_token(channel1, invalid_token):  # pylint: disable=W0621
    '''
